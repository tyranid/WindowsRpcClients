...
namespace rpc_df1941c5_fe89_4e79_bf10_463657acf44d_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_13(Struct_1[] p0, long p1)
        {
        ...
        public void Write_21(Struct_12[] p0, long p1)
        {
            WriteConformantStructArray<Struct_12>(p0, p1);
        }
        public void Write_22(NtApiDotNet.Ndr.Marshal.NdrPipe<sbyte> p0)
        {
            WritePipe<sbyte>(p0);
        }
        public void Write_23(NtApiDotNet.Ndr.Marshal.NdrPipe<sbyte> p0)
        {
            WritePipe<sbyte>(p0);
        }
    }
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public Struct_12[] Read_21()
        {
            return ReadConformantStructArray<Struct_12>();
        }
        public NtApiDotNet.Ndr.Marshal.NdrPipe<sbyte> Read_22()
        {
            return ReadPipe<sbyte>();
        }
        public NtApiDotNet.Ndr.Marshal.NdrPipe<sbyte> Read_23()
        {
            return ReadPipe<sbyte>();
        }
    }
    ...
    public struct Struct_0 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<Struct_1[], long>(Member8, new System.Action<Struct_1[], long>(m.Write_13), Member0);
        }
        ...
        {
            Member0 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<Struct_1[]>(new System.Func<Struct_1[]>(u.Read_13), false);
        }
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_3(Member2);
            m.Write_14(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member8, "Member8"), Member1);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_5 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteInt32(Member0);
            m.WriteEmbeddedPointer<Struct_6[], long>(Member8, new System.Action<Struct_6[], long>(m.Write_17), Member0);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        {
            Member0 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<Struct_6[]>(new System.Func<Struct_6[]>(u.Read_17), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long>(Member8, new System.Action<sbyte[], long>(m.Write_18), Member4);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_11 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteInt32(Member0);
            m.WriteEmbeddedPointer<Struct_12[], long>(Member8, new System.Action<Struct_12[], long>(m.Write_21), Member0);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        {
            Member0 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<Struct_12[]>(new System.Func<Struct_12[]>(u.Read_21), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int EfsRpcWriteFileRaw(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrPipe<sbyte> p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.Write_23(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"));
