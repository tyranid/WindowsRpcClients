...
namespace rpc_4b112204_0e19_11d3_b42b_0000f81feb9f_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        {
            WriteUnsupported(p0, "FC_BOGUS_ARRAY - char*[2]");
        }
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        {
            return ReadUnsupported("FC_BOGUS_ARRAY - char*[2]");
        }
    ...
    public struct Struct_0 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<Struct_2[], long>(Member60, new System.Action<Struct_2[], long>(m.Write_6), Member58);
            m.WriteInt32(Member68);
            m.WriteEmbeddedPointer<string[], long>(Member70, new System.Action<string[], long>(m.Write_7), Member68);
        }
        ...
        public int Member58;
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_2[]> Member60;
        public int Member68;
        ...
        public Struct_0(string Member0, string Member8, string Member10, string Member18, string Member20, int Member28, int Member2C, string Member30, System.Guid Member38, string Member48, string Member50, int Member58, Struct_2[] Member60, int Member68, string[] Member70)
        {
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteGuid(Member0);
            m.Write_8(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member10, "Member10"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        public Struct_2(System.Guid Member0, NtApiDotNet.Ndr.Marshal.NdrUnsupported Member10)
        {
            this.Member0 = Member0;
            this.Member10 = Member10;
        }
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_3(NtApiDotNet.Ndr.Marshal.NdrEnum16 Member0, string Member8, string Member10, string Member18, System.Guid Member20, string Member30, int Member38, Struct_2[] Member40, int Member48, string[] Member50)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int _SSDPOpenRpc(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
        ...
        public int _SSDPCloseRpc(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int RegisterServiceExRpc(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, Struct_0 p1, int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_0(p1);
            m.WriteInt32(p2);
        ...
        public int _DeregisterServiceRpc(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
        ...
        public int BeginSearchRpc(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, int p2, System.Guid p3, int p4)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int EnableNotificationRpc(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int _InitializeSyncHandle(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public void _RemoveSyncHandle(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int _GetNotificationRpc(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out System.Nullable<Struct_5> p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public int _WakeupGetNotificationRpc(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public void SetICSInterfaces(int p0, System.Guid[] p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.Write_12(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"), p0);
        ...
        public int EnableFirewallRuleRpc(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, int p2, string p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p1);
            m.WriteInt32(p2);
        ...
        public int DisableFirewallRuleRpc(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
