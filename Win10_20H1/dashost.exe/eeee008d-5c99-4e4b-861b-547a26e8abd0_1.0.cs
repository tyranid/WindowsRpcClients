...
namespace rpc_eeee008d_5c99_4e4b_861b_547a26e8abd0_1_0
{
    ...
    public struct Struct_1 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<Struct_4[], long>(Member48, new System.Action<Struct_4[], long>(m.Write_11), Member40);
            m.WriteInt32(Member50);
            m.WriteEmbeddedPointer<Struct_6[], long>(Member58, new System.Action<Struct_6[], long>(m.Write_12), Member50);
            m.WriteInt32(Member60);
            m.WriteEmbeddedPointer<Struct_8[], long>(Member68, new System.Action<Struct_8[], long>(m.Write_13), Member60);
        }
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<char[], long>(Member8, new System.Action<char[], long>(m.Write_14), Member0);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        {
            Member0 = u.ReadInt32();
            Member8 = u.ReadEmbeddedPointer<char[]>(new System.Func<char[]>(u.Read_14), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long>(Member28, new System.Action<sbyte[], long>(m.Write_15), Member24);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member28 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_15), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_8 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long>(Member20, new System.Action<sbyte[], long>(m.Write_16), Member18);
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member20 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_16), false);
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
            return 4;
    ...
    public struct Struct_10 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteInt32(Member10);
            m.WriteEmbeddedPointer<string[], long>(Member18, new System.Action<string[], long>(m.Write_17), Member10);
            m.WriteInt32(Member20);
            m.WriteEmbeddedPointer<string[], long>(Member28, new System.Action<string[], long>(m.Write_18), Member20);
        ...
        public Struct_10(int Member0, string Member8, int Member10, string[] Member18, int Member20, string[] Member28, System.Nullable<System.Guid> Member30, int Member38, string Member40, string Member48, string Member50)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public struct Struct_11 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        {
            m.WriteInt32(Member0);
            m.WriteEmbeddedPointer<Struct_7[], long>(Member8, new System.Action<Struct_7[], long>(m.Write_19), Member0);
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int DasHostProviderQueryGetResult(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, out sbyte[] p2)
        {
            ...
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_20), false);
            return u.ReadInt32();
        }
        public int DasHostCreateAssociationContext(System.Guid p0, string p1, int p2, long p3, long p4, int p5, Struct_9[] p6, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
        ...
        public int DasHostCreateAssociationContextFromOobBlob(System.Guid p0, System.Guid p1, int p2, sbyte[] p3, long p4, long p5, int p6, out string p7, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p8, out int p9, out Struct_7[] p10)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteGuid(p0);
            m.WriteGuid(p1);
        ...
        public int DasHostStartFinalize(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, out Struct_7[] p2, out int p3)
        {
            ...
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<Struct_7[]>(new System.Func<Struct_7[]>(u.Read_28), false);
            p3 = u.ReadInt32();
            return u.ReadInt32();
        }
        // async
