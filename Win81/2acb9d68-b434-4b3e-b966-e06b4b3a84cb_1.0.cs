...
namespace rpc_2acb9d68_b434_4b3e_b966_e06b4b3a84cb_1_0
{
    ...
    public struct Struct_1 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_3(Member11C, ((int)(Member110)));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_2(int Member0, long Member8, int Member10, sbyte[] Member14)
        {
            this.Member0 = Member0;
    ...
    public struct Union_3 : NtApiDotNet.Ndr.Marshal.INdrNonEncapsulatedUnion
    {
        ...
        public Union_3(NtApiDotNet.Ndr.Marshal.NdrEnum16 Selector, int Arm_3, int Arm_5, int Arm_4, NtApiDotNet.Ndr.Marshal.NdrEmpty Arm_Default)
        {
    ...
    public struct Struct_4 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_5(Member20);
            m.Write_5(Member30);
            m.Write_7(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member40, "Member40"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
        ...
        public Struct_4(int Member0, long Member8, int Member10, int Member14, int Member18, int Member1C, Struct_5 Member20, Struct_5 Member30, string Member40)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint BthServRegisterAuthenticationEvent(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, long p2, long p3, int p4, int p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p2);
        ...
        public uint BthServSetDeviceName(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, long p2, string p3)
        {
            ...
            m.WriteContextHandle(p0);
            m.WriteInt64(p2);
            m.Write_7(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p3, "p3"));
        ...
        public uint BthServUpdateService(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, int p2, sbyte[] p3, int p4)
        {
            ...
            m.WriteContextHandle(p0);
            m.WriteInt32(p2);
            m.Write_10(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p3, "p3"), p2);
            m.WriteInt32(p4);
        ...
        public uint BthServSetSdpRecordWithInfo(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, int p2, int p3, int p4, int p5, sbyte[] p6, out long p7)
        {
            ...
            m.WriteInt32(p4);
            m.WriteInt32(p5);
            m.Write_11(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p6, "p6"), p5);
        ...
        public uint BthServUninstallDevice(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, string p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.Write_12(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p2, "p2"));
