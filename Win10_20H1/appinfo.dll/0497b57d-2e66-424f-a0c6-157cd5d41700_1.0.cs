...
namespace rpc_0497b57d_2e66_424f_a0c6_157cd5d41700_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int RAiGetPackageActivationTokenForAlias(string p0, NtApiDotNet.NtToken p1, out NtApiDotNet.NtToken p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        // async
        public int RAiGetPackageActivationTokenForSxS(string p0, NtApiDotNet.NtToken p1, out NtApiDotNet.NtToken p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.Write_4(p1);
        ...
        // async
        public int RAiCreateJitvSilo(string p0, out int p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
        ...
        // async
        public int RAiCloseJitvSilo(int p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
