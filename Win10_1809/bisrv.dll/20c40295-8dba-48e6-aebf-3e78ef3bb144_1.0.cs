...
namespace rpc_20c40295_8dba_48e6_aebf_3e78ef3bb144_1_0
{
    ...
    {
        public Client() : 
                base("20c40295-8dba-48e6-aebf-3e78ef3bb144", 1, 0)
        {
        }
        ...
        public int SrvOdbPtLaunchBackgroundTask(int p0, string p1, string p2, System.Nullable<System.Guid> p3, byte[] p4, int p5, System.Nullable<Struct_1> p6, out System.Guid p7)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            ...
            m.WriteReferent(p4, new System.Action<byte[], long>(m.Write_1), p5);
            m.WriteInt32(p5);
            m.WriteReferent(p6, new System.Action<Struct_1>(m.Write_0));
