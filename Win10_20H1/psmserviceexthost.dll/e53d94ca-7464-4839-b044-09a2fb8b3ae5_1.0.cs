...
namespace rpc_e53d94ca_7464_4839_b044_09a2fb8b3ae5_1_0
{
    ...
    internal class _Marshal_Helper : NtApiDotNet.Ndr.Marshal.NdrMarshalBuffer
    {
        ...
        public void Write_13(NtApiDotNet.NtProcess p0)
        {
    ...
    internal class _Unmarshal_Helper : NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer
    {
        ...
        public NtApiDotNet.NtProcess Read_13()
        {
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_7(int Member0, int Member4, int Member8, int MemberC, int Member10)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member8 = Member8;
    ...
    public struct Struct_8 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_8(byte Member0, byte Member1)
        {
            this.Member0 = Member0;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint HamRpcSrvCreateActivity(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, byte[] p2, int p3, int p4, int p5, long p6, Struct_1 p7, NtApiDotNet.NtProcess p8, out long p9)
        {
            ...
            m.Write_12(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p2, "p2"), p3);
            m.WriteInt32(p3);
            m.WriteInt32(p4);
            m.WriteInt32(p5);
            m.WriteInt64(p6);
        ...
        public uint HamRpcSrvCreateAutoRestartActivityForDesktopBridge(string p0, byte[] p1, int p2, int p3, int p4, long p5, out long p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public uint HamRpcSrvCreateRegistrationActivityForDesktopBridge(string p0, byte[] p1, int p2, int p3, int p4, long p5, out long p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.Write_12(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p1, "p1"), p2);
        ...
        public uint HamRpcSrvCloseDesktopBridgeActivity(long p0, long p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt64(p0);
            m.WriteInt64(p1);
        ...
        public uint HamRpcSrvQueryActivityPendDiagnostics(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, out Struct_6 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
        ...
        public uint HamRpcSrvSetExternalResourcePriority(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, Struct_8 p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
