...
namespace rpc_7ea70bcf_48af_4f6a_8968_6a440754d5fa_1_0
{
    ...
    public struct Struct_5 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<sbyte[], long>(Member0, new System.Action<sbyte[], long>(m.Write_10), Member8);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_10), false);
            Member8 = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
        {
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<sbyte[], long>(Member0, new System.Action<sbyte[], long>(m.Write_10), Member8);
            m.WriteInt32(Member8);
            m.WriteEmbeddedPointer<sbyte[], long>(Member10, new System.Action<sbyte[], long>(m.Write_12), Member18);
            m.WriteInt32(Member18);
            m.WriteEmbeddedPointer<sbyte[], long>(Member20, new System.Action<sbyte[], long>(m.Write_13), Member28);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_10), false);
            Member8 = u.ReadInt32();
            Member10 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_12), false);
    ...
    public struct Struct_8 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            m.WriteEmbeddedPointer<sbyte[], long>(Member0, new System.Action<sbyte[], long>(m.Write_14), MemberC);
            m.WriteInt32(Member8);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            Member0 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_14), false);
            Member8 = u.ReadInt32();
            MemberC = u.ReadInt32();
        }
        int NtApiDotNet.Ndr.Marshal.INdrStructure.GetAlignment()
    ...
    public struct Struct_9 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteInt32(Member8);
            m.WriteInt32(MemberC);
            m.WriteEmbeddedPointer<sbyte[], long>(Member10, new System.Action<sbyte[], long>(m.Write_15), Member1C);
            m.WriteInt32(Member18);
            m.WriteInt32(Member1C);
            m.WriteEmbeddedPointer<sbyte[], long>(Member20, new System.Action<sbyte[], long>(m.Write_16), Member2C);
            m.WriteInt32(Member28);
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int RpcNsiRegisterChangeNotification(Struct_0 p0, out NtApiDotNet.Ndr.Marshal.NdrContextHandle p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_0(p0);
        ...
        public int RpcNsiParameterChange(Struct_0 p0, Struct_5 p1, Struct_6 p2, NtApiDotNet.Ndr.Marshal.NdrEnum16 p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.Write_0(p0);
            m.Write_4(p1);
