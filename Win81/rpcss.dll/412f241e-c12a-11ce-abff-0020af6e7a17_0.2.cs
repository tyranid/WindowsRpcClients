...
namespace rpc_412f241e_c12a_11ce_abff_0020af6e7a17_0_2
{
    ...
    public struct Struct_6 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_6(int Member0, int Member4, long Member8, long Member10, System.Guid Member18)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member8 = Member8;
    ...
    public struct Struct_7 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<Struct_9>(Member28, new System.Action<Struct_9>(m.Write_8));
        ...
        public int Member20;
        public NtApiDotNet.Ndr.Marshal.NdrEmbeddedPointer<Struct_9> Member28;
        public System.Guid Member30;
        public static Struct_7 CreateDefault()
        {
            return new Struct_7();
        }
        public Struct_7(int Member0, int Member4, int Member8, Struct_8 MemberC, System.Guid Member10, int Member20, System.Nullable<Struct_9> Member28, System.Guid Member30)
        {
            this.Member0 = Member0;
            this.Member4 = Member4;
            this.Member8 = Member8;
    ...
    public struct Struct_9 : NtApiDotNet.Ndr.Marshal.INdrConformantStructure
    {
        ...
        public Struct_9(short Member0, short Member2, short[] Member4)
        {
            this.Member0 = Member0;
            this.Member2 = Member2;
            this.Member4 = Member4;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int RegisterWindowPropInterface(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrUInt3264 p1, Struct_6 p2, Struct_7 p3, int p4, out NtApiDotNet.Ndr.Marshal.NdrUInt3264 p5, out uint p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteUInt3264(p1);
        ...
        public int GetWindowPropInterface(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, NtApiDotNet.Ndr.Marshal.NdrUInt3264 p1, NtApiDotNet.Ndr.Marshal.NdrUInt3264 p2, int p3, out Struct_6 p4, out Struct_7 p5, out uint p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteUInt3264(p1);
        ...
        public int GetCurrentAddrExclusionList(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, out int p1, out string[] p2, out uint p3)
        {
            ...
            p1 = u.ReadInt32();
            p2 = u.ReadReferent<string[]>(new System.Func<string[]>(u.Read_13), false);
            p3 = u.ReadUInt32();
            return u.ReadInt32();
        }
        public int SetAddrExclusionList(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string[] p2, out uint p3)
        {
            ...
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
            m.WriteReferent(p2, new System.Action<string[], long>(m.Write_14), p1);
