...
namespace rpc_b25a52bf_e5dd_4f4a_aea6_8ca7272a0e86_2_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int s_SrvRpcCryptCreateClaim(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, long p2, long p3, int p4, System.Nullable<Struct_7> p5, ref byte[] p6, int p7, out int p8, int p9)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
        ...
        public int s_SrvRpcCryptVerifyClaim(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, long p1, long p2, long p3, int p4, System.Nullable<Struct_7> p5, byte[] p6, int p7, out Struct_7 p8, int p9)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt64(p1);
