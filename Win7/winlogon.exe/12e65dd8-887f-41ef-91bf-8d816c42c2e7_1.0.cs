...
namespace rpc_12e65dd8_887f_41ef_91bf_8d816c42c2e7_1_0
{
    ...
    public struct Struct_0 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.WriteEmbeddedPointer<sbyte[], long, long>(Member50, new System.Action<sbyte[], long, long>(m.Write_2), Member48, Member48);
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member50 = u.ReadEmbeddedPointer<sbyte[]>(new System.Func<sbyte[]>(u.Read_2), false);
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        // async
        public int WlSecureDesktoprPromptingRequest(int p0, Struct_0 p1, string p2, string p3, int p4, int p5, sbyte[] p6, int p7, int p8, int p9, out sbyte[] p10, out int p11, out int p12, out int p13, ref int p14)
        {
            ...
            m.WriteInt32(p4);
            m.WriteInt32(p5);
            m.WriteReferent(p6, new System.Action<sbyte[], long>(m.Write_3), p7);
            m.WriteInt32(p7);
            m.WriteInt32(p8);
            m.WriteInt32(p9);
            m.WriteInt32(p14);
            _Unmarshal_Helper u = SendReceive(0, m);
            p10 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_4), false);
            p11 = u.ReadInt32();
            p12 = u.ReadInt32();
            p13 = u.ReadInt32();
            p14 = u.ReadInt32();
        ...
        public int WlSecureDesktoprConfirmationRequest(string p0, int p1, int p2, int p3, out char[] p4, out int p5, out sbyte[] p6, out int p7)
        {
            ...
            p4 = u.ReadReferent<char[]>(new System.Func<char[]>(u.Read_5), false);
            p5 = u.ReadInt32();
            p6 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_6), false);
            p7 = u.ReadInt32();
            return u.ReadInt32();
        }
        // async
