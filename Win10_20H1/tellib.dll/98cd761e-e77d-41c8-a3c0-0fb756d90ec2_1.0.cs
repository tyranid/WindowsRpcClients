...
namespace rpc_98cd761e_e77d_41c8_a3c0_0fb756d90ec2_1_0
{
    ...
    public struct Struct_0 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Unmarshal(_Unmarshal_Helper u)
        {
            ...
            Member1F38 = u.ReadEmbeddedPointer<string[]>(new System.Func<string[]>(u.Read_4), false);
    ...
    public struct Struct_1 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_6(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member82, "Member82"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public struct Struct_2 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        private void Marshal(_Marshal_Helper m)
        {
            ...
            m.Write_8(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(Member102, "Member102"));
        }
        void NtApiDotNet.Ndr.Marshal.INdrStructure.Unmarshal(NtApiDotNet.Ndr.Marshal.NdrUnmarshalBuffer u)
        {
            Unmarshal(((_Unmarshal_Helper)(u)));
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int UtcWerHelperApi_FetchReportCount(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, out int p2)
        {
        ...
        public int UtcWerHelperApi_FetchReportData(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, out Struct_0[] p2, out int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
        ...
        public int UtcWerHelperApi_ExtractReport(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, string p2, string p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
