...
namespace rpc_9b8699ae_0e44_47b1_8e7f_86a461d7ecdc_0_0
{
    ...
    public struct Struct_3 : NtApiDotNet.Ndr.Marshal.INdrStructure
    {
        ...
        public Struct_3(string Member0, string Member8, int Member10, int Member14, int Member18, long Member20, long Member28)
        {
            this.Member0 = Member0;
            this.Member8 = Member8;
            this.Member10 = Member10;
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint _CertifyServerIdentity(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, string p8, string p9, string p10, int p11, int p12, out int p13)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            m.WriteInt32(p1);
        ...
        public uint _QueryNTService(System.Nullable<System.Guid> p0, string p1, long p2, out int p3, out int p4, out int p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public uint _QueryNTServiceType(string p0, out int p1, out int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public uint ControlNTService(System.Nullable<System.Guid> p0, string p1, long p2, int p3, out int p4, out int p5, out int p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteReferent(p1, new System.Action<string>(m.WriteTerminatedString));
