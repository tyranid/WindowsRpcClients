...
namespace rpc_f50aac00_c7f3_428e_a022_a6b71bfb9d43_2_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int s_SSCatDBEnumCatalogs(string p0, NtApiDotNet.Ndr.Marshal.NdrEnum16 p1, int p2, byte[] p3, out int p4, out string[] p5)
        {
            ...
            p4 = u.ReadInt32();
            p5 = u.ReadReferent<string[]>(new System.Func<string[]>(u.Read_3), false);
            return u.ReadInt32();
        }
        ...
        public int s_SSCatDBQueryChainByCerts(int p0, Struct_0[] p1, out int p2, out Struct_0[] p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            ...
            p2 = u.ReadInt32();
            p3 = u.ReadReferent<Struct_0[]>(new System.Func<Struct_0[]>(u.Read_6), false);
            return u.ReadInt32();
        }
    }
    #endregion
