...
namespace rpc_6c9b7b96_45a8_4cca_9eb3_e21ccf8b5a89_1_0
{
    ...
    {
        public Client() : 
                base("6c9b7b96-45a8-4cca-9eb3-e21ccf8b5a89", 1, 0)
        {
        }
        ...
        public int UmpoRpcReadFromSystemPowerKey(System.Nullable<System.Guid> p0, System.Nullable<System.Guid> p1, System.Nullable<System.Guid> p2, int p3, ref System.Nullable<int> p4, int p5, ref sbyte[] p6, int p7, out int p8)
        {
            ...
            m.WriteInt32(p5);
            m.WriteReferent(p6, new System.Action<sbyte[], long>(m.Write_0), p7);
            m.WriteInt32(p7);
            _Unmarshal_Helper u = SendReceive(0, m);
            p4 = u.ReadReferentValue<int>(new System.Func<int>(u.ReadInt32), false);
            p6 = u.ReadReferent<sbyte[]>(new System.Func<sbyte[]>(u.Read_0), false);
            p8 = u.ReadInt32();
            return u.ReadInt32();
        }
        public int UmpoRpcReadFromUserPowerKey(System.Nullable<System.Guid> p0, System.Nullable<System.Guid> p1, System.Nullable<System.Guid> p2, int p3, ref sbyte[] p4, int p5, out int p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteReferent(p1, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteReferent(p2, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteInt32(p3);
            m.WriteReferent(p4, new System.Action<sbyte[], long>(m.Write_1), p5);
            m.WriteInt32(p5);
        ...
        public int UmpoRpcWriteToSystemPowerKey(System.Nullable<System.Guid> p0, System.Nullable<System.Guid> p1, System.Nullable<System.Guid> p2, int p3, int p4, int p5, sbyte[] p6, int p7)
        {
            ...
            m.WriteInt32(p4);
            m.WriteInt32(p5);
            m.Write_0(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p6, "p6"), p7);
            m.WriteInt32(p7);
        ...
        public int UmpoRpcWriteToUserPowerKey(System.Nullable<System.Guid> p0, System.Nullable<System.Guid> p1, System.Nullable<System.Guid> p2, int p3, int p4, sbyte[] p5, int p6)
        {
            ...
            m.WriteInt32(p3);
            m.WriteInt32(p4);
            m.Write_2(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p5, "p5"), p6);
            m.WriteInt32(p6);
        ...
        public int UmpoRpcApplyPowerSettings()
        {
            _Marshal_Helper m = new _Marshal_Helper();
            _Unmarshal_Helper u = SendReceive(7, m);
            return u.ReadInt32();
        }
        public int UmpoRpcSetActiveScheme(System.Nullable<System.Guid> p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteReferent(p0, new System.Action<System.Guid>(m.WriteGuid));
        ...
        public int UmpoRpcSettingUnregisterNotification(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int UmpoRpcReadSecurityDescriptor(int p0, System.Nullable<System.Guid> p1, ref sbyte[] p2, int p3, out int p4)
        {
            ...
            m.WriteInt32(p0);
            m.WriteReferent(p1, new System.Action<System.Guid>(m.WriteGuid));
            m.WriteReferent(p2, new System.Action<sbyte[], long>(m.Write_3), p3);
            m.WriteInt32(p3);
        ...
        public void UmpoRpcSetAlsBrightnessOffset(int p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteInt32(p0);
            _Unmarshal_Helper u = SendReceive(26, m);
        }
        public int UmpoRpcGetPlatformRole()
        {
            _Marshal_Helper m = new _Marshal_Helper();
