...
namespace rpc_0b0a6584_9e0f_11cf_a3cf_00805f68cb1b_1_1
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public void ept_insert_ex(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, Struct_0[] p2, int p3, int p4, out int p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
        ...
        public void ept_delete_ex(ref NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, int p1, Struct_0[] p2, out int p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
            m.WriteInt32(p1);
