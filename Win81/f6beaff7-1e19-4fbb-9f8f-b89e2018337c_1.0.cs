...
namespace rpc_f6beaff7_1e19_4fbb_9f8f_b89e2018337c_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public uint _EvtRpcRegisterControllableOperation(out NtApiDotNet.Ndr.Marshal.NdrContextHandle p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public uint _EvtRpcExportLog(NtApiDotNet.Ndr.Marshal.NdrContextHandle p0, string p1, string p2, string p3, int p4, out Struct_1 p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteContextHandle(p0);
        ...
        public uint _EvtRpcPutChannelConfig(string p0, int p1, Struct_2 p2, out Struct_1 p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
