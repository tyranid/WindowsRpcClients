...
namespace rpc_86d35949_83c9_4044_b424_db363231fd0c_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int _SchRpcHighestVersion(out int p0)
        {
        ...
        public int SchRpcRegisterTask(string p0, string p1, int p2, string p3, int p4, int p5, Struct_0[] p6, out string p7, out System.Nullable<Struct_1> p8)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int _SchRpcRetrieveTask(string p0, string p1, int p2, out string p3)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int _SchRpcEnumFolders(string p0, int p1, ref int p2, int p3, out int p4, out string[] p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
        ...
        public int _SchRpcEnumTasks(string p0, int p1, ref int p2, int p3, out int p4, out string[] p5)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
        ...
        public int _SchRpcScheduledRuntimes(string p0, System.Nullable<Struct_3> p1, System.Nullable<Struct_3> p2, int p3, int p4, out int p5, out Struct_3[] p6)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
        ...
        public int _SchRpcGetLastRunInfo(string p0, out Struct_3 p1, out int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
        ...
        public int _SchRpcEnableTask(string p0, int p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
