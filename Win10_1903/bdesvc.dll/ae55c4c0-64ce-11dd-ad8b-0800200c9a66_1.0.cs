...
namespace rpc_ae55c4c0_64ce_11dd_ad8b_0800200c9a66_1_0
{
    ...
    public sealed class Client : NtApiDotNet.Win32.Rpc.RpcClientBase
    {
        ...
        public int BdeSvcApipAddRecoveryPassword(string p0, out System.Guid p1)
        {
        ...
        public int BdeSvcApipConversionEncryptEx(string p0, int p1, int p2)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
            m.WriteInt32(p1);
        ...
        public int BdeSvcApipCheckADSchema()
        {
            _Marshal_Helper m = new _Marshal_Helper();
            _Unmarshal_Helper u = SendReceive(5, m);
            return u.ReadInt32();
        }
        public int BdeSvcApipQueryCachedEASProtectionStatus(out int p0, out int p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int BdeSvcApipDoTurnOnDeviceEncryption()
        {
            _Marshal_Helper m = new _Marshal_Helper();
            _Unmarshal_Helper u = SendReceive(7, m);
            return u.ReadInt32();
        }
        public int BdeSvcApipEnableSilentDeviceEncryption()
        {
            _Marshal_Helper m = new _Marshal_Helper();
            _Unmarshal_Helper u = SendReceive(8, m);
            return u.ReadInt32();
        }
        public int BdeSvcApipEnableSilentBitLocker()
        {
            _Marshal_Helper m = new _Marshal_Helper();
            _Unmarshal_Helper u = SendReceive(9, m);
            return u.ReadInt32();
        }
        public int BdeSvcApipIsEncryptableFDVPresent(out int p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
        ...
        public int BdeSvcApipRotateRecoveryPasswords(string p0)
        {
            _Marshal_Helper m = new _Marshal_Helper();
            m.WriteTerminatedString(NtApiDotNet.Win32.Rpc.RpcUtils.CheckNull(p0, "p0"));
        ...
        public int BdeSvcApipGetRotateRecoveryPasswordsStatus(out int p0, out string p1)
        {
            _Marshal_Helper m = new _Marshal_Helper();
